...
var KeyBasePoints = [8]int64{
	...
	250,  // a relay list is a very strong indicator
	5,    // tag hints are often autogenerated so we don't care very much about them (that may change)
	2,    // hints in associated events are even worse, they're not even supposed to be related
...
func (hk HintKey) String() string {
	...
	case LastInTag:
		return "last_in_tag"
	case LastInAssociatedEventTag:
		return "last_in_associated_event_tag"
	case LastInNprofile:
